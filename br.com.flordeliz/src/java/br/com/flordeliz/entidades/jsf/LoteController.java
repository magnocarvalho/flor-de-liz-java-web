...
import br.com.flordeliz.entidades.bean.LoteFacade;
...
public class LoteController implements Serializable {
    ...
    @EJB
    private br.com.flordeliz.entidades.bean.LoteFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/resource/Bundle").getString("LoteCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/resource/Bundle").getString("LoteUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/resource/Bundle").getString("LoteDeleted"));
        if (!JsfUtil.isValidationFailed()) {
