...
public class ClienteController implements Serializable {
    ...
    @EJB
    private br.com.flordeliz.entidades.bean.ClienteFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/resource/Bundle").getString("ClienteCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/resource/Bundle").getString("ClienteUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/resource/Bundle").getString("ClienteDeleted"));
        if (!JsfUtil.isValidationFailed()) {
