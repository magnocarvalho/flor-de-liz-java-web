...
import br.com.flordeliz.entidades.bean.PedidoFacade;
...
public class PedidoController implements Serializable {
    ...
    @EJB
    private br.com.flordeliz.entidades.bean.PedidoFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/resource/Bundle").getString("PedidoCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/resource/Bundle").getString("PedidoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/resource/Bundle").getString("PedidoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
